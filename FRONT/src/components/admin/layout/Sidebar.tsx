...
import {Cog6ToothIcon, ChartBarIcon,UserIcon, BookOpenIcon
...
const NavItem: React.FC<NavItemprops> = ({to, icon:Icon, label, currentPath}) =>{
    ...
    return (
        <li>
            ...
            ${isActive? 'bg-primary-admin-sidebar-active-bg text-primary-admin-sidebar-active-text shadow-lg flex items-center' :
