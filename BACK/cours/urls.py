...
from .views import (
    AdminFormationByUserApproveAPIView, AdminFormationByUserDeleteAPIView, AdminFormationByUserListAPIView, 
    FormationByUserListAPIView, FormationByUserPaymentAPIView, LoginProf, PaymentReceiptView, ProfProfile, RegisterView,
    ...
    ProfStudentAPIView, AdminLoginAPIView
)
...
urlpatterns = [
    ...
    path('prof-login/', LoginProf.as_view(), name='prof-login'),
    path('prof/me/', ProfProfile.as_view(), name='prof-profile'),
    ...
    path('profStudents/<int:prof_id>/', ProfStudentAPIView.as_view(), name='prof_students'),
]
